 ...
 */
    ...
    internal static class Patch_TryFindBestBetterStoreCellFor
    {
            ...
            for (; i < code.Count; i++)
            {
                ...
                if (code[i].opcode == OpCodes.Stloc_1)
                {
                    ...
                    yield return new CodeInstruction(OpCodes.Call,
                        AccessTools.Method(typeof(Patch_TryFindBestBetterStoreCellFor), "OverCapacity"));
        ...
        private static bool OverCapacity(Map map, Thing thing, ref StoragePriority storagePriority)
        {
            ...
            for (var i = 0; i < l.Count; i++)
            {
                ...
                if (thingInStorage.def.EverStorable(false))
                {
                    ...
                    if (stacksStoredHere >= cds.maxNumberStacks)
                    {
